...
class ColorModelTest extends Base
{
    ...
    public function testGetCss()
    {
        ...
        $this->assertStringContainsString('.task-board.color-yellow .task-board-project, .task-board.color-yellow .task-tags .task-tag, .task-summary-container.color-yellow .task-tags .task-tag {background-color: rgb(248, 249, 211);border-color: rgb(223, 227, 45);font-weight: bold;}', $css);
        $this->assertStringContainsString('.task-tag.color-yellow {background-color: rgb(248, 249, 211);border-color: rgb(223, 227, 45);font-weight: bold;}', $css);
    }
}
